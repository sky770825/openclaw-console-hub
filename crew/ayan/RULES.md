...
1. **禁止未經驗證就當事實回報** — 爬到的資料必須交叉比對至少 2 個來源，單一來源標註「未驗證」，絕不能當確認事實呈報給老蔡或其他 bot。
...
5. **Report（回報）**：將報告存入 `~/.openclaw/workspace/crew/ayan/reports/`，通知阿策或老蔡。
