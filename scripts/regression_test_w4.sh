...
if jq . "/Users/sky770825/.openclaw/workspace/skills/aegis_scanner.json" > /dev/null; then
...
"/Users/sky770825/.openclaw/workspace/scripts/run_aegis_scan.sh" "/tmp" "fast" > /dev/null

# Test 3: Output Verification
LATEST_REPORT=$(ls -t "/Users/sky770825/.openclaw/workspace/sandbox/output"/scan_report_*.txt | head -1)
