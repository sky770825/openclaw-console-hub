...
const VALID_ACTIONS = new Set([
  ...
  'run_script', 'ask_ai', 'ask_claude', 'ask_minimax', 'semantic_search', 'query_supabase',
...
3. 分析判斷：ask_ai（flash=日常、pro=架構）/ ask_minimax（便宜前沿、大量分析）/ ask_claude（精準推理）
...
{"action":"ask_minimax","model":"m2.7","prompt":"大量分析或長文處理（便宜前沿）","context":"背景"}
{"action":"ask_minimax","model":"highspeed","prompt":"需要快速回應的任務"}
