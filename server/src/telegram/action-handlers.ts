...
// ── Google API key 輪替（防止單一 key 配額耗盡）──
...
export async function handleSemanticSearch(query: string, limit: number = 5, mode: string = 'task'): Promise<ActionResult> {
...
// ── 網站生成 / 銷售詢價 / 作品集（已拆到 actions/site-generator.ts）──
import { handleGenerateSite, handleSalesInquiry, handleListPortfolio } from './actions/site-generator.js';
export { handleGenerateSite, handleSalesInquiry, handleListPortfolio };
// ── 自動記憶 ──
