...
- Do NOT modify these core brain files (小蔡的大腦，只有老蔡能改):
  - ${PROJECT_ROOT}/server/src/telegram/xiaocai-think.ts
  - ${PROJECT_ROOT}/server/src/telegram/bot-polling.ts
  - ${PROJECT_ROOT}/server/src/telegram/security.ts
  - ${PROJECT_ROOT}/server/src/index.ts
- You CAN read and modify other files in ${PROJECT_ROOT}/server/src/ (e.g. executor-agents.ts, routes/, utils/)
