...
export const createTaskSchema = z.object({
  ...
  owner: z.string().optional().default('system'),
  priority: prioritySchema.optional().default(3),
  scheduleType: scheduleTypeSchema.optional().default('manual'),
  ...
  riskLevel: taskRiskLevelSchema.optional().default('low'),
  deadline: z.string().datetime().nullable().optional(),
  reviewer: z.string().optional(),
  rollbackPlan: z.string().optional().default('git checkout HEAD~1'),
  acceptanceCriteria: z.array(z.string()).optional().default(['任務完成']),
  evidenceLinks: z.array(z.string()).optional(),
  summary: z.string().max(5000).optional(),
  nextSteps: z.array(z.string()).optional(),
  reporterTarget: z.string().optional(),
  projectPath: z.string().optional().default('projects/default/'),
  deliverables: z.array(z.string()).optional().default(['RESULT.md']),
  runCommands: z.array(z.string()).optional(),
  modelPolicy: z.string().optional().default('cost-first'),
  allowPaid: z.boolean().optional().default(false),
  executionProvider: z.string().optional().default('local'),
