...
### 1. 共同基礎
兩者皆調用 security.ts 中的 isPathSafe 函式，並會將相對路徑解析至 NEUXA_WORKSPACE (/Users/sky770825/.openclaw/workspace)。
...
- 封鎖範圍 (更嚴格):
    ...
    3. 源碼保護: 絕對禁止寫入 /server/src/ 或 /server/dist/。這確保了 AI 無法直接修改運行中的伺服器邏輯，只有「主人」手動操作才能修改。
