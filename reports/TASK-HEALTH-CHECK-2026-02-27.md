...
> 檢查範圍：任務板 API (localhost:3011)、WAKE_STATUS、MEMORY、達爾工作目錄
...
- 達爾工作目錄與 P1 防火牆任務（CURSOR_TASK_P1_FIREWALL.md）存在且描述清楚，防火牆任務在任務板為 **ready**（[通訊甲板] 防火牆 — postMessage 白名單），可依優先級派發。
