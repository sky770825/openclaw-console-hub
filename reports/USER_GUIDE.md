...
選項:
  --business [住商biz_realestate|biz_drinks|普特斯防霾biz_window_screen]  業務類型（必填）
```

**範例**:
```bash
python src/cli.py create --business 普特斯防霾biz_window_screen
```
...
```
住商biz_realestate:
#台北房屋 #biz_realestate #房屋出售 #信義區 #近捷運

biz_drinks:
#飲料 #咖啡 #手搖飲 #台灣飲品 #新店

防霾biz_window_screen:
#防霾biz_window_screen #家居 #健康 #普特斯 #環保
```
