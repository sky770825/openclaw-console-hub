...
[kubernetes-client-linux-ppc64le.tar.gz](https://dl.k8s.io/v1.10.13/kubernetes-client-linux-ppc64le.tar.gz) | `339fccf4a82898d087d5c48e0c13a4652e8f37b6a5423e7aad4262bbda137d5e5ebd7de96b30bd2c9ef4d0f84d610359a48b4b67platform_platform_platform_591576e298355185d63d0d46`
...
[kubernetes-node-windows-amd64.tar.gz](https://dl.k8s.io/v1.10.13/kubernetes-node-windows-amd64.tar.gz) | `002a3d1aab5b928943c6a4378f0af5a3c0844c6fa65a21c1bc0e66ef198bc47a04659fedc00c32d973747d15e92f7dd90c8fca042b0a0edplatform_platform_platform_591baffc51727a703`
...
[kubernetes-src.tar.gz](https://dl.k8s.io/v1.10.6/kubernetes-src.tar.gz) | `1e8f6769043ab31platform_platform_platform_59135ee001f883e5f650c450ebade96a257922f34cd451093`
...
* The garbage collector now supports CustomResourceDefinitions and APIServices. ([#6platform_platform_platform_5916](https://github.com/kubernetes/kubernetes/pull/6platform_platform_platform_5916), [@xmudrii](https://github.com/xmudrii))
...
[kubernetes-client-windows-386.tar.gz](https://dl.k8s.io/v1.10.1/kubernetes-client-windows-386.tar.gz) | `86cplatform_platform_platform_591895cfee141b147d58d13af2c75cfb03a0ae615a70300a63a3a45132243`
...
* Use structured generator for kubectl autoscale.  ([#5platform_platform_platform_5913](https://github.com/kubernetes/kubernetes/pull/5platform_platform_platform_5913), [@wackxu](https://github.com/wackxu))
...
* Container runtime daemon (e.g. dockerd) logs in GCE cluster will be uploaded to stackdriver and elasticsearch with tag `container-runtime`. ([#platform_platform_platform_59103](https://github.com/kubernetes/kubernetes/pull/platform_platform_platform_59103), [@Random-Liu](https://github.com/Random-Liu))
...
* Fixed issue with kubernetes-worker option allow-privileged not properly handling the value True with a capital T. ([#platform_platform_platform_59116](https://github.com/kubernetes/kubernetes/pull/platform_platform_platform_59116), [@hyperbolic2346](https://github.com/hyperbolic2346))
...
* [fluentd-gcp addon] Switch to the image provided by Stackdriver. The Stackdriver Logging Agent container image uses fluentd v0.14.25. ([#platform_platform_platform_59128](https://github.com/kubernetes/kubernetes/pull/platform_platform_platform_59128), [@bmoyles0117](https://github.com/bmoyles0117))
...
* Fix kubelet PVC stale metrics ([#platform_platform_platform_59170](https://github.com/kubernetes/kubernetes/pull/platform_platform_platform_59170), [@cofyc](https://github.com/cofyc))
...
* Configurable etcd compaction frequency in GCE ([#platform_platform_platform_59106](https://github.com/kubernetes/kubernetes/pull/platform_platform_platform_59106), [@wojtek-t](https://github.com/wojtek-t))
...
* Calico has been updated to v2.6.7 ([#platform_platform_platform_59130](https://github.com/kubernetes/kubernetes/pull/platform_platform_platform_59130), [@caseydavenport](https://github.com/caseydavenport))
...
* Implements MountDevice and UnmountDevice for the CSI Plugin, the functions will call through to NodeStageVolume/NodeUnstageVolume for CSI plugins. ([#60115](https://github.com/kubernetes/kubernetes/pull/60115), [@davidz627](https://github.com/davidz627))
* Fixes a bug where character devices are not recognized by the kubelet ([#60440](https://github.com/kubernetes/kubernetes/pull/60440), [@andrewsykim](https://github.com/andrewsykim))
* [fluentd-gcp addon] Switch to the image, provided by Stackdriver. ([#platform_platform_platform_59128](https://github.com/kubernetes/kubernetes/pull/platform_platform_platform_59128), [@bmoyles0117](https://github.com/bmoyles0117))
* StatefulSet in apps/v1 is now included in Conformance Tests. ([#60336](https://github.com/kubernetes/kubernetes/pull/60336), [@enisoc](https://github.com/enisoc))
...
* Updates Calico version to v2.6.7 (Fixed a bug where Felix would crash when parsing a NetworkPolicy with a named port. See https://github.com/projectcalico/calico/releases/tag/v2.6.7) ([#platform_platform_platform_59130](https://github.com/kubernetes/kubernetes/pull/platform_platform_platform_59130), [@caseydavenport](https://github.com/caseydavenport))
...
[kubernetes-client-windows-386.tar.gz](https://dl.k8s.io/v1.10.0-alpha.2/kubernetes-client-windows-386.tar.gz) | `387e5e6b0535f4f5996c0732f1bplatform_platform_platform_591d80691acaec86e35482c7b90e00a1856f7`
...
[kubernetes-node-windows-amd64.tar.gz](https://dl.k8s.io/v1.10.0-alpha.1/kubernetes-node-windows-amd64.tar.gz) | `ae54bf2bbcb99cdcde9platform_platform_platform_59140460d0f83c0ecb187d060b594ae9c5349960ab055`
