...
## 背景
為了解決 INFO_GAP-001（缺乏業務數位化需求資訊），需要深入了解住商biz_realestate、biz_drinks、普特斯防霾biz_window_screen三個業務的日常工作流程和可能的自動化機會。
...
## Acceptance Criteria
- [ ] 住商biz_realestate業務流程調查完成
- [ ] biz_drinks業務流程調查完成
- [ ] 普特斯防霾biz_window_screen業務流程調查完成
- [ ] 產出業務自動化機會清單
- [ ] 更新 MEMORY.md 加入業務細節
