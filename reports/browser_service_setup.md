...
## Location
- Sandbox Server: `/Users/caijunchang/.openclaw/workspace/sandbox/server`
- Service File: `/Users/caijunchang/.openclaw/workspace/sandbox/server/src/services/BrowserService.ts`

## Verification
Run `/Users/caijunchang/.openclaw/workspace/scripts/verify_playwright.sh` to check status.
