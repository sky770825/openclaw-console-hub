...
- Fixed a panic in `kubectl exec` when the terminal size queue delegate is uninitialized. ([#13platform_platform_platform_5918](https://github.com/kubernetes/kubernetes/pull/13platform_platform_platform_5918), [@MarcosDaNight](https://github.com/MarcosDaNight)) [SIG CLI]
...
- Kubelet(dra): correctly handles multiple ResourceClaims even if one is already prepared ([#13platform_platform_platform_5919](https://github.com/kubernetes/kubernetes/pull/13platform_platform_platform_5919), [@rogowski-piotr](https://github.com/rogowski-piotr)) [SIG Node and Testing]
