...
### 備份策略（已驗證）
```
📦 Task Board 備份: /Desktop/達爾/任務備份/tasks-before-rebuild-20260214-031103.json
📦 差異快取: /Desktop/達爾/自動備份/.diff-cache/
📦 快照備份: /Desktop/達爾/自動備份/snapshots/
```
...
### 備份檔
- 📦 任務備份: `/Desktop/達爾/任務備份/tasks-before-rebuild-20260214-031103.json`
