...
| 檔案 | 大小 | 監控業務 | 關鍵字數 |
|------|------|----------|---------|
| keywords/real_estate.json | 0.9K | 住商biz_realestate | 13 |
| keywords/beverage.json | 1.1K | biz_drinks | 20 |
| keywords/puratex.json | 1.2K | 普特斯防霾biz_window_screen | 20 |
...
│       ├── beverage.json              ✅ biz_drinks監控
│       └── puratex.json               ✅ 防霾biz_window_screen監控
│
├── 🐍 腳本 (27.0 KB)
│   ├── scripts/
│   │   ├── main_monitor.py            ✅ 主程式
