...
- **原始碼範例參考**:
```
/Users/caijunchang/openclaw任務面版設計/src/config/communityLayers.ts:    enabled: true, // v0.7 啟用：需滿足 trustPromotion.ts 升級條件
/Users/caijunchang/openclaw任務面版設計/src/index.css:  .animate-fade-in {
/Users/caijunchang/openclaw任務面版設計/src/index.css:  .animate-slide-up {
/Users/caijunchang/openclaw任務面版設計/src/index.css:  .animate-slide-right {
/Users/caijunchang/openclaw任務面版設計/src/index.css:  .animate-pulse-glow {
/Users/caijunchang/openclaw任務面版設計/src/index.css:  .animate-oc-pulse {
/Users/caijunchang/openclaw任務面版設計/src/index.css:.animate-gradient-shift {
/Users/caijunchang/openclaw任務面版設計/src/index.css:::view-transition-old(root),
/Users/caijunchang/openclaw任務面版設計/src/index.css:::view-transition-new(root) {
/Users/caijunchang/openclaw任務面版設計/src/index.css:::view-transition-old(root) {
/Users/caijunchang/openclaw任務面版設計/src/index.css:::view-transition-new(root) {
/Users/caijunchang/openclaw任務面版設計/src/index.css:@supports (transition-behavior: allow-discrete) {
/Users/caijunchang/openclaw任務面版設計/src/index.css:    transition-behavior: allow-discrete;
...
/Users/caijunchang/openclaw任務面版設計/src/components/ui/card.tsx:  <div ref={ref} className={cn("rounded-xl border border-[var(--oc-border)] bg-[var(--oc-s2)] text-[var(--oc-t1)] transition-all hover:bg-[var(--oc-s3)]", className)} {...props} />
/Users/caijunchang/openclaw任務面版設計/src/components/ui/slider.tsx:    <SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border-2 border-primary bg-background ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50" />
```
