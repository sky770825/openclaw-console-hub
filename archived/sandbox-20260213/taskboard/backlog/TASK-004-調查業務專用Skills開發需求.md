...
## 背景
為了解決 SKILL_GAP-003（缺乏業務專用 skills），需要調查不動產、餐飲、建材銷售行業常用的軟體和平台，評估開發整合 skills 的可行性。

## 目標
1. 調查不動產業常用系統（如：內政部不動產登記、591 房屋交易等）✅
...
## 主要結論
### 優先開發清單 (P1)
1. `skill-591-scraper` - 不動產 591 房源自動追蹤
2. `skill-ichef-api` - 飲料店銷售數據分析
