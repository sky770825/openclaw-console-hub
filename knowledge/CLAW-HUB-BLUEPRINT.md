...
ClawHub 是 NEUXA 與主人的共享數位軍火庫。它不是一個專案，而是一個存放、管理和複用所有高價值、經過驗證的「可執行資產」（Executable Assets）的註冊中心。
...
- 所有 ClawHub 資產存放在 /Users/sky770825/.openclaw/workspace/armory/
...
這是 ClawHub 的第一個正式資產，旨在將主人從重複的物件搜尋中解放出來。
...
- 執行流程：
    ...
    7. 呼叫 Telegram API，將 Markdown 報告發送給主人。
- 輸出：
...
- [ ] 建立 /Users/sky770825/.openclaw/workspace/armory/realestate-monitor-591 目錄。
- [ ] 開發核心的 run.sh 腳本。
- [ ] 建立 README.md 文件。
- [ ] 進行端對端測試。