...
| **會員系統** | 已支援：帳號密碼登入、自行註冊（信箱+密碼）、寄送登入連結 | 電話驗證登入將於後續推出；表結構見 SUPABASE-SETUP.md |
...
| 項目 | 狀態 |
|------|------|
| 後台 admin.html | ✅ 已建，Supabase 審核 + OTP 角色門禁（moderator/admin/superadmin）；後台頁內已加全站導航（首頁、討論區、功過格、加持商城、加持台） |
...
- **全站導航**：測驗、懺悔祈福牆、參悟、討論區、加持台、加持商城等入口已出現在所有子頁 nav；後台 admin 頁內也有導航可回各區；會員任務中心 tasks 導航已與他頁一致（含加持台、懺悔、諸神、地獄、輪迴等）。
