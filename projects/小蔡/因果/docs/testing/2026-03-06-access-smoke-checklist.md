...
## Anon
- [ ] 開 [首頁](/Users/caijunchang/.openclaw/workspace/projects/小蔡/因果/index.html)，可正常瀏覽
- [ ] 開 [討論區](/Users/caijunchang/.openclaw/workspace/projects/小蔡/因果/pages/forum.html)，可看到已核准文章列表
- [ ] 開 [文章頁](/Users/caijunchang/.openclaw/workspace/projects/小蔡/因果/pages/post.html)，可看到已核准文章與留言
- [ ] 在首頁投稿，預期：若站點已接 Supabase，應提示「請先登入會員後再投稿」
- [ ] 在文章頁留言，預期：應提示「請先登入會員後再留言」
- [ ] 在文章頁留言按讚，預期：應提示「請先登入會員後再按讚」
- [ ] 開 [任務中心](/Users/caijunchang/.openclaw/workspace/projects/小蔡/因果/pages/tasks.html)，預期：提示尚未登入會員
- [ ] 開 [功過格](/Users/caijunchang/.openclaw/workspace/projects/小蔡/因果/pages/merit.html) 後點同步，預期：提示尚未登入會員
- [ ] 開 [懺悔牆](/Users/caijunchang/.openclaw/workspace/projects/小蔡/因果/pages/wall.html)，預期：可看本機內容，但不會載入會員雲端牆
...
- [ ] 直接開 [後台](/Users/caijunchang/.openclaw/workspace/projects/小蔡/因果/pages/admin.html)，預期：顯示 `權限不足`

## Moderator / Admin
- [ ] 用 `admin_active` 登入 [後台](/Users/caijunchang/.openclaw/workspace/projects/小蔡/因果/pages/admin.html)，預期：可通過驗證並看到待審核投稿
