...
- `Supabase Auth` 目前沒有原生 `LINE` social provider，不能直接在前端把 `provider` 改成 `line`
- 如果你要支援 LINE 註冊 / 登入，請看：
  - [LINE-LOGIN-INTEGRATION-2026-03-07.md](/Users/caijunchang/.openclaw/workspace/projects/小蔡/因果/docs/LINE-LOGIN-INTEGRATION-2026-03-07.md)
- 建議架構是 `LINE Login -> Edge Function / callback -> 自簽 JWT -> Supabase RLS`
