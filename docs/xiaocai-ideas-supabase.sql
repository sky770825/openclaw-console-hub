...
CREATE POLICY "Allow all operations" ON xiaocai_ideas
...
-- 5. 插入預設資料
INSERT INTO xiaocai_ideas (id, title, summary, file_path, status, tags)
VALUES (
  'idea-001',
  'Token 消耗優化策略',
  '發現 5 個高 Token 情境：連續錯誤重試、重複搜尋、大段代碼複製等，提出搜尋快取、指數退避、Context 壓縮等解決方案。',
  'docs/xiaocai-ideas/pending/idea-001-token-optimization.md',
  'pending',
